        ...
        ScrollViewReader { proxy in
            ScrollView {
                ...
                Group {
                    ...
                    Text("Without a Watch everything works except the heart rate: the countdown runs, the session is logged with its duration, and no zones are shown rather than empty ones.")
                }
